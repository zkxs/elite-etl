...
where distance < 10 -- 10 ly is max range of data delivery
and a_system_id = b_nearest -- make sure there is no closer system that could have missions
and b_system_id = a_nearest
and a_second_nearest > 10 -- make sure second nearest system is out of data delivery range
and b_second_nearest > 10
